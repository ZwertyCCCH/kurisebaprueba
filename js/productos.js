...
const productos = {
    ...
    individuales: [
        { id: 22, nombre: "Gohan Teriyaki", descripcion: "Base de arroz con palta, queso crema, cebollín, sésamo y pollo teriyaki", precio: 6500, img: "assets/img/gohanteriyaki.jpeg" },
        { id: 23, nombre: "Gohan Acebichado", descripcion: "Base de arroz con palta, cebollín, almendras y ceviche", precio: 7500, img: "assets/img/gohanaceb.jpeg" },
        { id: 24, nombre: "Gohan Teriyaki Eby", descripcion: "Base de arroz con palta, queso crema, cebollín, sésamo, papas al hilo, pollo teriyaki y camarón cocido", precio: 8000, img: "assets/img/gohantereby.jpeg" },
        { id: 25, nombre: "Gohan Acebichado Tory", descripcion: "Base de arroz con palta, almendras, cebollín, sésamo, pollo teriyaki y ceviche", precio: 8500, img: "assets/img/gohanacebtory.jpeg" },
        { id: 24, nombre: "Gohan Sake Eby", descripcion: "Base de arroz con palta, queso crema, cebollín, salmón y camarón cocido", precio: 8000, img: "assets/img/gohansakeeby.jpeg" },
        { id: 24, nombre: "Gohan Maguro", descripcion: "Base de arroz con palta, atún, camarón cocido y kanikama furai", precio: 8000, img: "assets/img/gohanmaguro.jpeg" },
        { id: 24, nombre: "Gohan Kuriseba", descripcion: "Base de arroz con palta, queso crema, cebollín, sésamo, salmón, camarón furai y pollo furai", precio: 8500, img: "assets/img/gohankuriseba.jpeg" },
        { id: 24, nombre: "Gohan de Salmón (sake)", descripcion: "Base de arroz con palta, queso crema, cebollín, sésamo y salmón", precio: 6500, img: "assets/img/gohansalmon.jpeg" },
        { id: 24, nombre: "Gohan Vegui (Champiñon Furay)", descripcion: "Base de arroz con cilantro, cebolla morada, champiñon tempurizado y pimentón", precio: 6500, img: "assets/img/gohanveg.jpeg" },
        { id: 24, nombre: "Gohan de Camarón (Ebi)", descripcion: "Base de arroz con palta, queso crema, cebollín, sésamo y camarón furai", precio: 6500, img: "assets/img/gohancamaron.jpeg" },
        { id: 24, nombre: "Sushi Burguer - Pollo", descripcion: "Relleno de Pollo, cebollín, palta y queso crema, envuelto en arroz tempurizado", precio: 6500, img: "assets/img/sushiburguerpollo.png" },
        { id: 24, nombre: "Sushi Burguer - Camarón", descripcion: "Relleno de Camarón, cebollín, palta y queso crema, envuelto en arroz tempurizado", precio: 6500, img: "assets/img/sushiburguercamaron.jpeg" },
        { id: 24, nombre: "Sushi Burguer - Salmón", descripcion: "Relleno de Salmón, cebollín, palta y queso crema, envuelto en arroz tempurizado", precio: 6500, img: "assets/img/sushiburguersalmon.png" },
        { id: 24, nombre: "Sushi Burguer - Vegui", descripcion: "Relleno de Champiñon, cebollín, palta y queso crema, envuelto en arroz tempurizado", precio: 6500, img: "assets/img/sushiburguerchampiñon.png" },
    ],
    aperitivos: [
        { id: 40, nombre: "Gyozas de Pollo (7 uds)", descripcion: "Gyozas crujientes rellenas de pollo y verduras", precio: 4500, img: "assets/img/gyosas.jpeg" },
        { id: 41, nombre: "Gyozas de Cerdo (7 uds)", descripcion: "Gyozas crujientes rellenas de cerdo y verduras", precio: 4500, img: "assets/img/gyosas.jpeg" },
        { id: 42, nombre: "Ebi Furai Americano (5 uds)", descripcion: "Camarones ecuatorianos 36/40 con queso mozarella en panko y salsa kuri", precio: 6000, img: "assets/img/ebiamericano.jpeg" },
        { id: 43, nombre: "Ebi Tempura (5 uds)", descripcion: "Camarones ecuatorianos 36/40 bañado en masa tempura y salsa kuri", precio: 5000, img: "assets/img/ebiamericano.jpeg" },
        { id: 45, nombre: "Korokke (5 uds)", descripcion: "Salmón, queso crema, cebollín, apanado en panko y salsa de maracuyá o kuri", precio: 5000, img: "assets/img/korokke.jpeg" },
        { id: 46, nombre: "Sashimi atún (6 uds)", descripcion: "6 cortes finos de atún", precio: 6500, img: "assets/img/sashimiatun.jpeg" },
        { id: 46, nombre: "Sashimi salmón (6 uds)", descripcion: "6 cortes finos de salmón", precio: 6500, img: "assets/img/sashimisalmon.jpeg" },
        { id: 46, nombre: "Sashimi pulpo (6 uds)", descripcion: "6 cortes finos de pulpo", precio: 6500, img: "assets/img/sashimipulpo.jpeg" },
        { id: 46, nombre: "Sashimi mixto (6 uds)", descripcion: "6 cortes finos mixtos de pulpo, salmón y atún", precio: 6500, img: "assets/img/sashimimixto.jpeg" },
        { id: 47, nombre: "Nigiri de pulpo", descripcion: "Sushi tradicional japonés con una porción de arroz junto a pulpo", precio: 1500, img: "assets/img/nigiripulpo.jpeg" },
        { id: 48, nombre: "Nigiri de atún", descripcion: "Sushi tradicional japonés con una porción de arroz junto a atún", precio: 1500, img: "assets/img/nigiriatun.jpeg" },
        { id: 49, nombre: "Nigiri de camarón", descripcion: "Sushi tradicional japonés con una porción de arroz junto a camarón", precio: 1500, img: "assets/img/nigiricamaron.jpeg" },
        { id: 48, nombre: "Nigiri de salmón", descripcion: "Sushi tradicional japonés con una porción de arroz junto a salmón", precio: 1500, img: "assets/img/nigirisalmon.jpeg" },
        { id: 48, nombre: "Papas fritas normales", descripcion: "Porción de papas fritas de 300 gramos", precio: 3000, img: "assets/img/papasfritas.avif" },
        { id: 48, nombre: "Papas fritas grandes", descripcion: "Porción de papas fritas de 600 gramos", precio: 5500, img: "assets/img/papasfritas.avif" },

    ],
    peruano: [
        { id: 40, nombre: "Tiritas de Pollo", descripcion: "Deliciosas tiritas de pollo apanado", precio: 5500, img: "assets/img/tiritaspollo.jpeg" },
        { id: 40, nombre: "Tiritas de Pollo, con Arroz y Papas Fritas", descripcion: "Deliciosas tiritas de pollo apanado acompañado de arroz y papas fritas", precio: 6500, img: "assets/img/tiritasapf.jpeg" },
        { id: 40, nombre: "Pollo Saltado", descripcion: "Delicioso pollo salteado con verduras, papas fritas y arroz", precio: 6000, img: "assets/img/pollosaltado.jpeg" },
        { id: 40, nombre: "Lomo Saltado", descripcion: "Delicioso lomo salteado con verduras, papas fritas y arroz", precio: 7500, img: "assets/img/pollosaltado.jpeg" },
        { id: 40, nombre: "Aeropuerto de pollo", descripcion: "Deliciosa combinación de arroz chaufa y tallarín salteado de pollo", precio: 6000, img: "assets/img/aeropuertopollo.jpeg" },
        { id: 40, nombre: "Chaufa de 3 sabores", descripcion: "Deliciosa combinación de arroz chaufa, con carne, pollo y camarón", precio: 9500, img: "assets/img/chaufa3.jpeg" },
        { id: 40, nombre: "Aeropuerto acebichado", descripcion: "Deliciosa combinación de arroz chaufa con tallarín salteado, junto con acebichado", precio: 9500, img: "assets/img/aeropuertoacebichado.jpeg" },
    ],
    extras: [
    // Salsas
    { id: 26, nombre: "Salsa de Soya", descripcion: "Clásica salsa de soja para sushi", precio: 700, img: "assets/img/salsasoya.jpg" },
    { id: 27, nombre: "Salsa Dulce", descripcion: "Salsa agridulce estilo teriyaki", precio: 700, img: "assets/img/salsadulce.png" },
    { id: 28, nombre: "Salsa Acebichada", descripcion: "Salsa cítrica estilo ceviche", precio: 700, img: "assets/img/salsaaceb.png" },
    { id: 29, nombre: "Salsa de Ajo", descripcion: "Salsa de ajo suave y aromática", precio: 700, img: "assets/img/salsaajo.jpg" },
    { id: 30, nombre: "Salsa de Olivo", descripcion: "Deliciosa salsa sabor aceitunas", precio: 700, img: "assets/img/salsaoliva.png" },
    { id: 31, nombre: "Salsa Picante", descripcion: "Salsa ligera con un toque picante", precio: 700, img: "assets/img/salsapicante.png" },
    { id: 32, nombre: "Salsa de Maracuyá", descripcion: "Exótica salsa agridulce de maracuyá", precio: 700, img: "assets/img/salsamaracuya.jpg" },
    
    // Complementos
    { id: 33, nombre: "Wasabi", descripcion: "Pasta de wasabi picante (porción)", precio: 500, img: "assets/img/wasabi.jpg" },
    { id: 34, nombre: "Jengibre Encurtido", descripcion: "Jengibre encurtido color rosa (porción)", precio: 700, img: "assets/img/jengibre.jpg" },
    
    // Utensilios
    { id: 35, nombre: "Palillos", descripcion: "Palillos de madera (1 par)", precio: 400, img: "assets/img/palillos.jpg" },
    ],
    bebestibles: [
        { id: 29, nombre: "Bebidas 1.5L", descripcion: "Bebidas gaseosas. Sabores disponibles: Coca Cola, Fanta, Sprite, Inca Kola", precio: 3000, img: "assets/img/bebidas15l.webp" },
        { id: 30, nombre: "Jugos 1.0 L", descripcion: "Jugos guayarauco. Sabores disponibles: Naranja, Piña Mango Naranja ", precio: 2800, img: "assets/img/guallarauco.jpg" },
        { id: 31, nombre: "Bebidas 500 mL", descripcion: "Bebidas gaseosas. Sabores disponibles: Coca Cola, Fanta, Sprite", precio: 1700, img: "assets/img/bebidas15l.webp" },
        { id: 32, nombre: "Jugo Del Valle 300 mL Boca Ancha", descripcion: "Jugo de frutas en botella de vidrio. Sabores disponibles: Durano, Piña, Naranja", precio: 1500, img: "assets/img/delvalle300ml.jpg" },
        { id: 33, nombre: "Bebidas 350 mL", descripcion: "Bebidas gaseosas. Sabores disponibles: Coca Cola, Fanta, Sprite", precio: 1200, img: "assets/img/latas.jpg" },
        { id: 33, nombre: "Agua embotelladas 500 mL", descripcion: "Agua con gas y sin gas", precio: 1000, img: "assets/img/agua.webp" },
    ]
};